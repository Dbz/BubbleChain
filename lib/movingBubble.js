(function() {
  ...
  var MovingBubble  = window.BubbleChain.MovingBubble = function(params) {
    ...
    this.vel        = BubbleChain.Util.randomVel(MovingBubble.SPEED);
    this.radius     = params.radius;
    this.color      = BubbleChain.Util.randomColor(params.level);
  ...
  MovingBubble.prototype.bounceOffWall = function() {
    // Mirror velocity
  ...
  MovingBubble.prototype.moveFromWall = function() {
