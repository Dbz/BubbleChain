(function() {
  ...
  level2.instructions = "Pop all of the GREEN bubbles. You LOSE points when BLUE bubbles pop.";
  ...
  level3.instructions = "Gain points for every bubble that you click and pop";
  ...
  level4.instructions = "Penalty round! Lose points for every bubble remaining after the timer runs out!";
  ...
  level5.instructions = "Bonus round! Gain points for every bubble popped before the timer runs out!";
