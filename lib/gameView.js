(function() {
	...
	gameView.prototype.setMenu = function() {
		...
		if(this.level == 1) {
			this.$menu.find('#text').text("Pop all the bubbles in as few clicks as possible. Pop a bubble by clicking on it. It'll expand and touch other bubbles popping them. You lose 100pts for every click. ");
